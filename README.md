...
| 地球儀の全体表示 | 拡大と大気の表現 | 用語の詳細カード | 用語一覧(時代順) | 一覧内の検索 |
|:---:|:---:|:---:|:---:|:---:|
| ![全体表示](docs/images/01_globe.png) | ![拡大](docs/images/02_zoom.png) | ![詳細カード](docs/images/03_detail.png) | ![用語一覧](docs/images/04_list.png) | ![一覧内検索](docs/images/05_search.png) |
